...
CREATE Procedure [dbo].[PrintableGradesheetLandscape]
(
@ClassID int,
...
Begin
	...
	Select top 1
		...
		@AssignmentCol2 = AssignmentTitle,
...
Begin
	...
	Select top 1 Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8, Col9 From #AssignmentsH
	Delete From #AssignmentsH Where IDCol = (Select top 1 IDCol From #AssignmentsH)
	...
	Insert Into #Gradesheet
	Select top 1 Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8, Col9 From #AvgAssignmentGradesH
	Delete From #AvgAssignmentGradesH Where IDCol = (Select top 1 IDCol From #AvgAssignmentGradesH)
