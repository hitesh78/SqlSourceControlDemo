...
CREATE Procedure [dbo].[PrintableGradesheetCustomLandscape]
(
@ClassID int,
...
Declare @CFCol7 nvarchar(200)
Declare @CFCol8 nvarchar(200)
Declare @CFCol9 nvarchar(200)
...
Begin
	...
	Select top 1
		@CFCol7 = replace(replace(replace(replace(CustomFieldName, char(10), ''), char(13), ''), '''', '\'''), '"', '\"'),
		@CustomFieldID = CustomFieldID
	From #CustomFieldsV
	Order By CustomFieldOrder;
	Delete From #CustomFieldsV Where CustomFieldID = @CustomFieldID;
	...
	Select top 1
		@CFCol8 = replace(replace(replace(replace(CustomFieldName, char(10), ''), char(13), ''), '''', '\'''), '"', '\"'),
		@CustomFieldID = CustomFieldID
	From #CustomFieldsV
	Order By CustomFieldOrder;
	Delete From #CustomFieldsV Where CustomFieldID = @CustomFieldID;
	...
	Select top 1
		@CFCol9 = replace(replace(replace(replace(CustomFieldName, char(10), ''), char(13), ''), '''', '\'''), '"', '\"'),
		@CustomFieldID = CustomFieldID
	From #CustomFieldsV
	Order By CustomFieldOrder;
	Delete From #CustomFieldsV Where CustomFieldID = @CustomFieldID;

	Insert into #CustomFieldsH (Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8, Col9)
	values
	(
	@CFCol1,
	@CFCol2,
...
Begin
	...
	Select top 1 Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8, Col9 From #CustomFieldsH
	...
	Begin
		...
		Insert Into #Gradesheet
		Select top 1 Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8, Col9 From #StudentsAndGrades
...
Select 	1 as tag,
		...
		@EK as [Head!1!EK],
		'Landscape' as [Head!1!Orientation],
