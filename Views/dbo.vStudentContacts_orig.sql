...
CREATE   VIEW [dbo].[vStudentContacts_orig] as
...
(
	...
	s.Email1,s.Email2,s.Email3,s.SchoolEmail,
	...
	c.email1, c.email2, c.email2,s.SchoolEmail,
	...
	inner join vStudents_orig s on s.StudentID = c.StudentID
	where s.StudentID<>-1
) x
GO
