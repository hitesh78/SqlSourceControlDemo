...
[SuccessfulVoiceCount] [int] NULL,
[FailedVoiceCount] [int] NULL,
[MessageURL] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
-- =============================================
CREATE TRIGGER [dbo].[UpdateVoiceMessageStatusToFailed]
   ON  [dbo].[CommVoiceLog]
   AFTER INSERT
AS 
BEGIN
	...
	Begin
		...
		(
			'SQL Server'
			,getdate()
			,'Error: Failed to finish Sending Voice Message within 1 Hour - MessageStatus set to Failed'
			, DB_NAME ()
			,'SQL Server - CommVoiceLog Trigger'
			,'https://secure.gradelink.com:443/SmartSend/api/749/Communicate/SendScheduledVoice'
			,
			(
			SELECT TOP 1
