...
CREATE FUNCTION [dbo].[splitSISphonesALL] (
...
begin
	...
	declare @instance int = 3; -- parse out up to 3 phones...
...
declare @rvTest nvarchar(100) = '';
	...
	if @instance>0
		set @rv2 = @rv2 + replicate('~',@instance-1)

	return @rv2 -- ltrim(rtrim(@rv)) --@rv --@rvTest just for testing, otherwise return @rv
end
GO
